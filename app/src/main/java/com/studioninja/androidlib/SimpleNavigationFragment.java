...
public class SimpleNavigationFragment extends NavigationFragment {
	...
	public void setupCustomItemLayout(int layoutResId, int textViewResId, int imageViewResId) {
	...
	private class NavigableAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (root == null) {
				root = LayoutInflater.from(mContext).inflate(mItemLayoutResId, parent, false);
			}
