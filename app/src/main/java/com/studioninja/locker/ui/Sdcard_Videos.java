...
public class Sdcard_Videos extends AppCompatActivity implements OnItemClickListener, OnClickListener {
	...
	private class MovefileTask extends AsyncTask<Context, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (Index < Album_id.size()) {
				...
				setup();
				Toast.makeText(getApplication(), "Video Has Been Hide", Toast.LENGTH_SHORT).show();
			}
