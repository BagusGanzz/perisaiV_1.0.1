...
public class OutgoingCallReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context c, Intent i) {
		...
		boolean launch = prefs.getBoolean(R.string.pref_key_dial_launch, R.bool.pref_def_dial_launch);
		String number = i.getStringExtra(Intent.EXTRA_PHONE_NUMBER);
		String launchNumber = prefs.getString(R.string.pref_key_dial_launch_number, R.string.pref_def_dial_launch_number);
